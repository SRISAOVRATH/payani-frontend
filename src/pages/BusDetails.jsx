...
export default function BusDetails() {
  ...
  return (
    <main className="page-shell bus-details-page">
      ...
      <section className="details-map-route-grid">
        ...
        <section className="detail-panel route-panel route-panel-side">
      ...
      <section className="journey-details-card journey-details-full">
